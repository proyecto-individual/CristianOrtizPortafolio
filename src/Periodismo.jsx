import ProyectoPeriodismo from "./ProyectoPeriodismo";
    ...
    <div>
      <section class="periodismo">
        ...
        <ProyectoPeriodismo
          ...
          lista={[
            "36 años después de la masacre en CAYARA",
            "Testimonios del genocidio de CAYARA",
            "Conmemoración del genocidio de CAYARA",
            "Santuario de la memoria"
          ]}
          imagenes={[
            "/img/periodismo/ayacucho-cayara/36 AÑOS DESPUES/_MG_1135-2.jpg",
            "/img/periodismo/ayacucho-cayara/CONMEMORACION CAYARA/SaveClip.App_445556534_1141270073774470_59776293952468177_n.jpg",
            "/img/periodismo/ayacucho-cayara/SANTUARIO DE LA MEMORIA/SaveClip.App_445602007_1014651937040862_1769144741978885962_n.jpg",
            "/img/periodismo/ayacucho-cayara/CAYARA TESTIMONIOS/juanaapari/_MG_8007-2.jpg"
          ]} />
        
        <ProyectoPeriodismo
          titulo="Foro del APEC y marcha en el Perú"
          descripcion={[
        ...
        <ProyectoPeriodismo
          titulo="Vencedores de ayacucho"
          descripcion={[
            "Patrimonio Cultural de la Nación.",
            "El último domingo 30 de Marzo se celebró el Carnaval \"Vencedores de Ayacucho\" donde diferentes instituciones provinciales de Ayacucho participaron del evento en la iconica plaza de Acho.",
        ...
        <ProyectoPeriodismo
          titulo="La comunidad indígena Shipibo-Konibo de Cantagallo"
          descripcion={[
        ...
        <ProyectoPeriodismo
          titulo="Marcha “Por la Justicia y la Dignidad”"
          descripcion={[
