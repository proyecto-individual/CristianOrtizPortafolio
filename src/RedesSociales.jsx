  ...
  return (
    <div className="redes-sociales">
      <a href="https://www.instagram.com/poorstreet.peru" target="_blank" rel="noreferrer">
        <img src="/img/img/instagram.png" className="instagram" alt="logoInstagram" title="@poorstreet.peru" />
      </a>
     <a href="https://wa.me/51927932694?text=Hola%20quiero%20más%20información" target="_blank" rel="noreferrer">
